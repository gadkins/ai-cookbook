...
class Lambda_Helper: 
    ...
    def __init__(self):
        ...
        self.function_name = 'LambdaFunctionCallSummarization'
        self.role_arn = f"arn:aws:iam::{account_id}:role/LambdaRoleCallSummarization"
        self.function_description = "Lambda function uploaded by a notebook for call summarization."
        self.lambda_arn = ""
